...
import { getFolders, getDashboardsWithoutFolders, getUserBySession, editUser } from '@/lib/actions';
                    ...
                    <div className='setting-type'>
                        ...
                        <div className='setting'>
                            <div>
                                ...
                                <form className='user-form' id='account-form' action={editUser}>
                                    ...
                                    <div className='user-form-group'>
                                        ...
                                        <div>
                                            <input type="password" name='password' placeholder='******' disabled={false} />
                                        </div>
                                    </div>
