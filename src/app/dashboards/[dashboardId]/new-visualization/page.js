...
import { getDashboardById, getUserBySession, saveChart } from "@/lib/actions";
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', backgroundColor: 'lightgray', width: '100%', padding: '10px' }}>
                    ...
                    <div>
                        ...
                        <button className='button'>
                            <Link className='route-link' href={`/dashboards/${dashboard?.id}`} style={{ color: '#ffffff' }}>Discard</Link>
                        </button>
                    </div>
                </div>
                ...
                <section className="visualization-settings tabs" style={{ display: 'flex', flexDirection: 'column', minWidth: '20%', padding: '5px' }}>
                    <div className="tab-container">
                        <div id="tab2" className="tab">
                            <a href="#tab2"><h4>Chart</h4></a>
                            <div className="tab-content" >
                                <h4>Chart Settings</h4>
                                <ChartForm data={queryRes} status={status} onFinalData={setFinalData}
                                    onFinalOptions={setFinalOptions} onChartType={setChartType}></ChartForm>
                            </div >
                        </div>
