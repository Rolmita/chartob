        ...
        <section>
            <NavSection>
                ...
                <Link className='route-link' href={`/dashboards/folder/${folder?.id}/${dashboard?.id}/${visualization?.id}`}>
                    Edit visualization {visualization?.id} {visualization?.options.plugins.title.text.length > 0
                        ? `(${visualization?.options.plugins.title.text})`
                        : ''}
                </Link>
            </NavSection>
            ...
            <Visualization data={queryRes} status={status} finalData={finalData} type={chartType} finalOpt={finalOptions} />
