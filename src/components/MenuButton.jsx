...
const MenuButton = ({ name, style, isFolder, folderId, dashboardId, user, list }) => {
    ...
    const handleEvent = async () => {
        switch (name) {
            case 'New Folder':
                ...
                console.log('la nueva carpeta es', newFolder)
    ...
    return (
        <div>
            {list
                ? <button type='submit' className='btn-menu-list' onClick={handleEvent} style={style}>{name}</button>
