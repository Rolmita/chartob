        ...
        <section className="visualization" style={{ minWidth: '100%', minHeight: '100%', flex: 1 }}>
            <div className="preview"
                ...
                <div style={{ marginBottom: '10px' }}>
                    ...
                    <button className='button' onClick={showGraphic}>Show Chart</button>
                ...
                <div className="preview-content" id='preview-content' style={{ display: 'none', minHeight: '50vh', backgroundColor: '#ffffff', borderRadius: '5px' }}>
                    ...
                    <div className="preview-graph" id="preview-graph" style={{ display: 'none', minHeight: '50vh', minWidth: '100%' }}>
                        {finalData && <ChartComponent data={finalData} options={finalOpt} type={type}></ChartComponent>}
                    </div>
                </div>
            </div>
        </section>
